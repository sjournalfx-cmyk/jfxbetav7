    ...
    <div className={clsx(
      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-[10px] opacity-40 font-bold uppercase tracking-widest mt-1">Bubble size = duration • Intensity = rating</p>
        </div>
    ...
    <div className={clsx(
      ...
      <div className="flex items-center justify-between mb-8">
        <div className="flex items-center gap-3">
          ...
          <h3 className="text-sm font-black uppercase tracking-[0.2em] opacity-60 text-white">Exposure Matrix</h3>
        </div>
      </div>
               ...
               >
                 ...
                 {pairList.map(p2 => {
                   ...
                   return (
                     <div 
                      key={`${p1}-${p2}`}
                      title={`${p1} × ${p2}: ${val} co-occurrences`}
                      className={clsx(
