                ...
                <div className="space-y-8 pb-20">
                    <div className="flex justify-between items-center">
                        ...
                        <button 
                            ...
                            className={`px-6 py-3 rounded-xl font-bold flex items-center gap-2 transition-all ${isDarkMode ? 'bg-zinc-800 hover:bg-zinc-700 text-white' : 'bg-black hover:bg-zinc-800 text-white'}`}
                        >
                            <Printer size={18} />
                            Generate PDF Report
                        </button>
